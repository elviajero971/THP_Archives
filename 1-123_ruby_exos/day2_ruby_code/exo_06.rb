...
#le programme n'affiche rien car il manque la définition de la variable 'number_of_minutes_in_an_hour' qu'on a ajoutée après. On a rajouté ensuite les unités à afficher.