...
function changeLogoName() {
  ...
  logoName.getElementsByClassName.fontSize = "2em";
}
...
function changeCardsText() {
  ...
  for (let step = 0; step < 4; step++) {
    ...
    if (step === 1) {
      ...
      cards[step].innerHTML = "Bootstrap est une collection d'outils utiles à la création du design de sites et d'applications web. C'est un ensemble qui contient des codes HTML et CSS, des formulaires."
    }
  }
}
