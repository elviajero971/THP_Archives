...
describe "Simon says" do
  ...
  describe "repeat" do
    ...
    it "should repeat a number of times" do
      expect(repeat("hello", 3)).to be == "hello hello hello"
    end
  end

  describe "start_of_word" do
    it "returns the first letter" do
      expect(start_of_word("hello", 1)).to be == "h"
    end

    it "returns the first two letters" do
      expect(start_of_word("Bob", 2)).to be == "Bo"
    end
  ...
  describe "first_word" do
    it "tells us the first word of 'Hello World' is 'Hello'" do
      expect(first_word("Hello World")).to be == "Hello"
    end

    it "tells us the first word of 'oh dear' is 'oh'" do
      expect(first_word("oh dear")).to be == "oh"
    end
  end

  describe "titleize" do
    it "capitalizes a word" do
      expect(titleize("jaws")).to be == "Jaws"
    end

    it "capitalizes every word (aka title case)" do
      expect(titleize("david copperfield")).to be == "David Copperfield"
    end

    it "doesn't capitalize 'little words' in a title" do
      expect(titleize("war and peace")).to be == "War and Peace"
    end

    it "does capitalize 'little words' at the start of a title" do
      expect(titleize("the bridge over the river kwai")).to be == "The Bridge Over the River Kwai"
    end
  end
